...
{
    std::vector<Item> items{{"A Generic Item", 1, 9}};
    GildedRose gilded_rose{items};
...
{
    std::vector<Item> items{{"A Generic Item", 3, 2}};
    GildedRose gilded_rose{items};
...
{
    std::vector<Item> items{{"Aged Brie", 3, 2}};
    GildedRose gilded_rose{items};
...
{
    std::vector<Item> items{{"Aged Brie", 3, 48}};
    GildedRose gilded_rose{items};
...
{
    std::vector<Item> items{{"Sulfuras, Hand of Ragnaros", 1, 80}};
    GildedRose gilded_rose{items};
...
{
    std::vector<Item> items{
        {"Backstage passes to a TAFKAL80ETC concert", 3, 48}};
    GildedRose gilded_rose{items};
...
{
    std::vector<Item> items{
        {"Backstage passes to a TAFKAL80ETC concert", 2, 3}};
    GildedRose gilded_rose{items};
